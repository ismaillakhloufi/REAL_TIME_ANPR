...
if uploaded_file is not None:
    ...
    detection_model = YOLO("Detection_model/best.pt")  # Replace with your detection model path

    # Load the recognition model (to recognize text within the regions)
    recognition_model = YOLO("OCR_model/best.pt")  # Replace with your recognition model path
